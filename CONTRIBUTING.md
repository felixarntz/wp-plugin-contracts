# Contribute to WP Plugin Contracts
...
* [open an issue](https://github.com/felixarntz/wp-plugin-contracts/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/felixarntz/wp-plugin-contracts/compare) to the `master` branch
